...
fail !0 exec $(CACHED) $(DPS_TEST_DIR)/cached.conf >> $(DPS_TEST_LOG) 2>&1
...
fail !0 exec sleep 30
fail !0 exec $(SPLITTER) -w $(DPS_TEST_DIR)/var $(DPS_TEST_DIR)/cached.conf >> $(DPS_TEST_LOG) 2>&1
