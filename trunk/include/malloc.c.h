...
static void internal_malloc_stats(mstate m) {
  ...
  if (!PREACTION(m)) {
    ...
    fprintf(stderr, "  [%x] max system bytes = %10lu\n", (int)m, (unsigned long)(maxfp));
    fprintf(stderr, "  [%x] system bytes     = %10lu\n", (int)m, (unsigned long)(fp));
    fprintf(stderr, "  [%x] in use bytes     = %10lu\n", (int)m, (unsigned long)(used));
